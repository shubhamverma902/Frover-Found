export const SEED_CATEGORIES = [
  {
    ...
    tasks: [
      { label: 'Book main wedding venue',           due: null, done: false },
      { label: 'Book sangeet & reception hall',     due: null, done: false },
  ...
  },
  {
    ...
    tasks: [
      { label: 'Finalise decoration theme',   due: null, done: false },
  ...
  },
  {
    ...
    tasks: [
      { label: 'Shortlist caterers',                       due: null, done: false },
      { label: 'Finalise multi-cuisine wedding menu',      due: null, done: false },
  ...
  },
  {
    ...
    tasks: [
      { label: 'Shortlist photographers',        due: null, done: false },
  ...
  },
  {
    ...
    tasks: [
      { label: 'Finalise guest list',        due: null, done: false },
      { label: 'Send e-invites',             due: null, done: false },
