  ...
  <div className="rounded-2xl overflow-hidden glow-gold-strong relative">
    ...
    <div className="bg-card dark:bg-[#2A1F52] rounded-2xl border border-blush/20 dark:border-gold/20 px-6 py-5 relative overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-1 relative">
        ...
        <p className="text-[10px] font-bold text-blush dark:text-gold uppercase tracking-[0.4em]">Account</p>
      </div>
      <h1 className="text-xl font-bold text-dark dark:text-white relative">Settings</h1>
      <p className="text-xs text-silver dark:text-silver/50 mt-1 relative">Manage your profile and wedding details</p>
    </div>
  </div>
);
