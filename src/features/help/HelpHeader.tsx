  ...
  <div className="bg-[#23292E] p-[3px] glow-gold-strong relative">
    ...
    <div className="border border-[#E4BC62]/20 px-6 py-5 relative overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-1 relative">
        ...
        <p className="text-[10px] font-bold text-[#E4BC62] uppercase tracking-[0.4em]">Support</p>
      </div>
      <h1 className="text-xl font-bold text-white relative">Help &amp; Support</h1>
      <p className="text-xs text-[#DDDED9]/50 mt-1 relative">Find answers, guides, and ways to reach our team</p>
    </div>
  </div>
);
