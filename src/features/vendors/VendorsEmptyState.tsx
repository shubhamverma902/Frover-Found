...
export const VendorsEmptyState = ({ onAddVendor }: VendorsEmptyStateProps) => (
  <div className="flex flex-col items-center py-16 px-6 text-center border border-dashed border-[#E4BC62]/20 bg-[#E4BC62]/[0.02]">
    ...
    <div className="relative mb-6">
      ...
      <div className="absolute inset-0 -z-10 blur-2xl bg-[#DFB3AE]/10 rounded-full scale-75" />
    </div>

    <p className="text-[10px] font-bold text-[#E4BC62]/60 uppercase tracking-[0.35em] mb-2">Vendors</p>
    <h2 className="text-base font-bold text-[#23292E] dark:text-white mb-3">No vendors added yet</h2>
