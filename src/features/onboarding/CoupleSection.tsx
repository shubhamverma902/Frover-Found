...
export const CoupleSection = ({ partner1, partner2, error1, error2, onChangePartner1, onChangePartner2 }: Props) => (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <OnboardingField label="Partner 1 Name" error={error1}>
        <Input type="text" placeholder="e.g. Priya Sharma"
          value={partner1} onChange={e => onChangePartner1(e.target.value)}
          width="100%" height={48} />
      </OnboardingField>
      <OnboardingField label="Partner 2 Name" error={error2}>
        <Input type="text" placeholder="e.g. Rahul Verma"
          value={partner2} onChange={e => onChangePartner2(e.target.value)}
          width="100%" height={48} />
      </OnboardingField>
    </div>
  </OnboardingSection>
