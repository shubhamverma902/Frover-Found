...
export const EventsEmptyState = ({ onAddEvent }: EventsEmptyStateProps) => (
  <div className="flex flex-col items-center py-16 px-6 text-center border border-dashed border-[#E4BC62]/20 bg-[#E4BC62]/[0.02]">
    ...
    <p className="text-[10px] font-bold text-[#E4BC62]/60 uppercase tracking-[0.35em] mb-2">Events</p>
    <h2 className="text-base font-bold text-[#23292E] dark:text-white mb-3">No events planned yet</h2>
