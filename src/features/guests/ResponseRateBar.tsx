...
export const ResponseRateBar = ({ responsePct, confirmed, declined, pending }: ResponseRateBarProps) => (
  <div className="bg-card border border-silver dark:border-[#2a2f33] px-6 py-4 shadow-crystal">
    <div className="flex items-center gap-4">
      ...
      <div className="flex-1">
        <div className="relative h-3 bg-silver/30 dark:bg-silver/10 overflow-hidden mb-1.5">
