...
export function Footer() {
  return (
    <footer className="bg-dark text-silver">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="mt-4 text-sm text-silver/55 leading-relaxed">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-silver/60">
            <li><a href="#services"     className="hover:text-gold transition-colors duration-200">Services</a></li>
            <li><a href="#gallery"      className="hover:text-gold transition-colors duration-200">Gallery</a></li>
            <li><a href="#testimonials" className="hover:text-gold transition-colors duration-200">Love Stories</a></li>
            <li><a href="#contact"      className="hover:text-gold transition-colors duration-200">Get in Touch</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-silver/60">
            <li><Link href={PATH.auth.login}  className="hover:text-gold transition-colors duration-200">Sign In</Link></li>
            <li><Link href={PATH.auth.signup} className="hover:text-gold transition-colors duration-200">Create Account</Link></li>
            <li><a href="#" className="hover:text-gold transition-colors duration-200">Dashboard</a></li>
            <li><a href="#" className="hover:text-gold transition-colors duration-200">Planning Tools</a></li>
          </ul>
        </div>
      ...
      {/* Bottom bar */}
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-silver/35">
