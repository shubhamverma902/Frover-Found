  ...
  <section id="testimonials" className="py-24 px-6 bg-white">
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-14">
        ...
        <h2 className="text-4xl font-bold text-dark">Couples who trusted us</h2>
      ...
      <div className="relative mb-6 rounded-3xl border border-silver bg-silver/25 px-8 py-10 lg:px-14 lg:py-12 overflow-hidden animate-fade-in-up">
        ...
        <div className="relative">
          ...
          <p className="text-xl lg:text-2xl text-dark leading-relaxed italic font-light max-w-4xl mb-8">
            &ldquo;{TESTIMONIALS[0].quote}&rdquo;
          </p>

          <div className="flex items-center gap-4">
            <div className="relative w-14 h-14 rounded-full overflow-hidden shrink-0 ring-2 ring-gold ring-offset-2 ring-offset-silver/25">
              <Image src={TESTIMONIALS[0].avatar} alt={TESTIMONIALS[0].names} fill sizes="56px" style={{ objectFit: 'cover' }} />
            </div>
            <div>
              <p className="font-bold text-dark">{TESTIMONIALS[0].names}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {TESTIMONIALS.slice(1).map((t, i) => (
          <div
            key={i}
            className="card-hover animate-fade-in-up relative rounded-3xl border border-silver bg-white px-7 py-8 overflow-hidden"
          ...
          >
            ...
            <div className="relative flex flex-col gap-4 h-full">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-silver">
                ...
                <div>
                  <p className="text-sm font-semibold text-dark">{t.names}</p>
